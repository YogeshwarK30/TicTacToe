...
public class GameActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String player1name = getIntent().getStringExtra("player_name1");
        ...
        Reset.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                xCount=0;
                oCount=0;
                scorex.setText(player1name+s1+String.valueOf(xCount));
                scoreo.setText(player2name+s1+String.valueOf(oCount));
                startGame="X";
            }
        });
        ...
        button1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Toast.makeText(GameActivity.this,"Button Already Pressed",Toast.LENGTH_SHORT).show();
                }
    ...
    private void winningGame()
    {
        ...
        if((b1==1) && (b2==1) && (b3==1))
        {
            ...
            builder.setMessage(player1name+" Won").setCancelable(false).setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                @Override
        ...
        else  if((b1==0) && (b2==0) && (b3==0))
        {
            ...
            AlertDialog.Builder builder=new AlertDialog.Builder(this);
            builder.setMessage(player2name+" Won").setCancelable(false).setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                @Override
                public void onClick(DialogInterface dialog, int which) {
                    button1.setImageDrawable(null);
                    button2.setImageDrawable(null);
        ...
        else
        {
            ...
            {
                AlertDialog.Builder builder=new AlertDialog.Builder(this);
                builder.setMessage("No Winner").setCancelable(false).setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        button1.setImageDrawable(null);
                        button2.setImageDrawable(null);
